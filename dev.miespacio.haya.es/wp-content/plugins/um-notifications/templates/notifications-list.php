...
foreach ( $notifications as $notification ) {
	...
	<div class="um-notification <?php echo esc_attr( $notification->status ); ?> <?php echo esc_attr( $notification->type ); ?>" data-notification_id="<?php echo esc_attr( $notification->id ); ?>" data-notification_uri="<?php echo esc_url( $notification->url ); ?>">
