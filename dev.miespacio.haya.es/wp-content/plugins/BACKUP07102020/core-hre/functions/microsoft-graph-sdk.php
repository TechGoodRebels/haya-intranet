		...
		<script type="text/javascript">
			...
			function getAccessToken() {
				...
				jQuery.ajax({
	                "async": false,
	                "crossDomain": true,
	                "url": "https://cors-anywhere.herokuapp.com/https://login.microsoftonline.com/<?php echo CORE_HRE_MICROSOFT_TENANT; ?>/oauth2/token", // Pass your tenant name instead of sharepointtechie
	                "method": "POST",
	                "headers": {
