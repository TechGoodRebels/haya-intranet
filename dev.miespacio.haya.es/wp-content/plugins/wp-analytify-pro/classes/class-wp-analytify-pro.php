						...
						<tbody>
							...
							<tr valign="top">
								...
								<?php
									...
									<?php do_action( 'wp_analytify_dimensions_license_key' ); ?>
									<?php do_action( 'wp_analytify_google_optimize_license_key' ); ?>
									<?php do_action( 'wp_analytify_events_tracking_license_key' ); ?>
			...
			if ( is_array( $show_settings ) ) {
				if ( in_array( 'show-geographic-dashboard', $show_settings ) ) {
					...
					<div class="analytify_general_status analytify_status_box_wraper">
						...
						<div class="analytify_status_footer">
							<span class="analytify_info_stats"><?php analytify_e( 'Listing statistics of top countries and cities.', 'wp-analytify' ); ?></span>
						</div>
					</div>
					<?php
				}
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-keywords-dashboard', $show_settings ) ) {
						...
						<div class="analytify_general_status analytify_status_box_wraper">
							...
							<div class="analytify_status_footer">
								<span class="analytify_info_stats"><?php analytify_e( 'Listing your ranked keywords', 'wp-analytify' ); ?></span>
							</div>
						</div>
						<?php
					}
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-social-dashboard', $show_settings ) ) {
						...
						<div class="analytify_general_status analytify_status_box_wraper">
							...
							<div class="analytify_status_footer">
								<span class="analytify_info_stats"><?php analytify_e( 'See how many users are coming to your site from Social media', 'wp-analytify' ); ?></span>
							</div>
						</div>
						<?php
					}
				...
				if ( is_array( $show_settings ) ) {
					if ( in_array( 'show-referrer-dashboard', $show_settings ) ) {
						...
						<div class="analytify_general_status analytify_status_box_wraper">
							...
							<div class="analytify_status_footer">
								<span class="analytify_info_stats"><?php analytify_e( 'Who are the top Referrers to your site? See above', 'wp-analytify' ); ?></span>
							</div>
						</div>
						<?php
					}
